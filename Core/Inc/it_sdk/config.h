...
#define ITSDK_CUBEMX_VERSION	    __CUBEMX_VERSION6XX						// Version of cube MX
#define ITSDK_PLATFORM 				__PLATFORM_STM32WLE						// Hardware platform selection
#define ITSDK_DEVICE				__DEVICE_STM32WLE5JC					// Specific device
#define ITSDK_WITH_DRIVERS			__DISABLE								// Includes configDrivers.h
#define ITSDK_RAM_SIZE				(64*1024)								// RAM Memory size
#define ITSDK_EPROM_SIZE			(6*1024)								// EEPROM size
#define ITSDK_WITH_UART				( __UART_LPUART1 )						// Use LPUART1 and USART2 for debug USART1 possible ( can't mix LPUART1 with USART1 )
#define ITSDK_WITH_UART_RXIRQ		__UART_LPUART1							// Setup some of the UART with IRQ enabled for RX
...
#define ITSDK_ADC1_PIN				63										// Map the channel for ADC on PIN 63 (PB14 - Channel 1)
...
#define ITSDK_WITH_SPI				( __SPI_SUBGHZ )			// Use SPI (includes the structures, bit field for the different type of SPI)
...
#define ITSDK_WDG_CLKFREQ			32000									// Watchdog clock source frequency
...
#define ITSDK_LOGGER_CONF			0x0F00									// error->info level on serial2 => USART2 + 1 (see logger.c)
...
#define ITSDK_LOWPOWER_MOD			( __LOWPWR_MODE_STOP       \
								...
								/*	| __LOWPWR_MODE_WAKE_UART1  */\
																			...
																			// UART WakeUp - Requires clk HSE/LSE and WakeInt Activated - low speed recommended

#define ITSDK_LOWPOWER_MINDUR_MS	5										// Under 5 ms sleep request, no need to sleep
#define ITSDK_LOWPOWER_RTC_MS		2000									// RTC wake up after 250ms
...
#define ITSDK_LOWPOWER_GPIO_A_KEEP	(  __LP_GPIO_NONE \
									 | __LP_GPIO_0   /* NA - RFSwitch Control 1 */\
									 | __LP_GPIO_1   /* NA - RFSwitch Control 2 */\
									 | __LP_GPIO_2   /* USART2 / LPUART1 - TX (UART on connector)  */\
									 | __LP_GPIO_3   /* USART2 / LPUART1 - RX (UART on connector)  */\
								/*	 | __LP_GPIO_4	*/ /* RFO Cnf1 */\
								/*	 | __LP_GPIO_5	*/ /* RFO Cnf2 */\
								/*	 | __LP_GPIO_6	*/ /* SPI1 MISO */\
								/*	 | __LP_GPIO_7	*/ /* SPI1 MOSI */\
								/*	 | __LP_GPIO_8	*/ /* NC */\
								/*	 | __LP_GPIO_9	*/ /* NC */\
								/*	 | __LP_GPIO_10	*/ /* LIS3DH INT1 */\
								/*	 | __LP_GPIO_11	*/ /* I2C SDA */\
								/*	 | __LP_GPIO_12	*/ /* I2C SCL */\
								/*	 | __LP_GPIO_13	*/ /* SWDIO */\
								/*	 | __LP_GPIO_14	*/ /* SWDCLK */\
								/*	 | __LP_GPIO_15	*/ /* TP12 */\
...
#define ITSDK_LOWPOWER_GPIO_B_KEEP	(  __LP_GPIO_NONE \
								...
								/*   | __LP_GPIO_1 */ /* NC */\
								/*	 | __LP_GPIO_2 */ /* NC */\
								/*	 | __LP_GPIO_3 */ /* ANALOG NTC Input */\
								/*	 | __LP_GPIO_4 */ /* NTC ENABLE OUTPUT */\
									 | __LP_GPIO_5    /* Activity Check (Seal) Input */\
								/*	 | __LP_GPIO_6 */ /* USART1 - TX ( Test Point ) */ \
								/*	 | __LP_GPIO_7 */ /* USART1 - RX ( Test Point ) */ \
								/*	 | __LP_GPIO_8 */ /* NC */\
								/*	 | __LP_GPIO_9 */ /* NC */\
								/*	 | __LP_GPIO_10	*/ /* NC */ \
								/*	 | __LP_GPIO_11	*/ /* NC */\
								/*	 | __LP_GPIO_12 */ /* NC */\
								/*	 | __LP_GPIO_13 */ /* NC - EEprom Write protect */\
								/*	 | __LP_GPIO_14 */ /* LIS 3DH INT2 */\
								/*	 | __LP_GPIO_15 */ /* NC - TP13 */\
...
#define ITSDK_LOWPOWER_GPIO_C_KEEP	(  __LP_GPIO_NONE  \
								...
								/*	  | __LP_GPIO_3 */ /* NC */\
								/*	  | __LP_GPIO_4 */ /* NC */\
								/*	  | __LP_GPIO_5 */ /* NC - BMX160 INT1 */\
								/*	  | __LP_GPIO_13 */ /* NC - TP11 */\
								/*	  | __LP_GPIO_14 */ /* OSC32 In */ \
								/*	  | __LP_GPIO_15 */ /* OSC32 Out */ \
									)										// keep radio
...
#define ITSKD_CONSOLE_COPYRIGHT		"(c) 2024 Paul Pinault\r\n"				// CHANGE ME : copyright string
...
#define ITSDK_SIGFOX_LIB			__SIGFOX_SX126X							// Type of Sigfox module
...
#define ITSDK_RADIO_MAX_OUTPUT_DBM  22										// Max power output
