...
#define ITSDK_SFX_SX126X_MODULE		__SX126X_MOD_LORAE5 //__SX126X_MOD_RAK3172				   // module reference for module / board specific conde & config
...
#define ITSDK_SFX_SX126X_TCXO_PWR	30									   // TCXO Voltage 16 for 1.6V, 16-18 22,24,27,30,33 value accepted
																		   // LORA-E5 module power TCXO from PB0 with VDD
#define ITSDK_SFX_SX126X_TCXO_BANK	__BANK_B							   // TCXO Power Pin, let sure it stays on when main clock
#define ITSDK_SFX_SX126X_TCXO_PIN	__LP_GPIO_NONE						   // RAK3172 Module - GPIOB_0
...
#define ITSDK_SFX_SX126X_RFSW1_PIN	__LP_GPIO_0							   //

#define ITSDK_SFX_SX126X_RFSW2_BANK	__BANK_A							   // Second Pin
#define ITSDK_SFX_SX126X_RFSW2_PIN	__LP_GPIO_1							   //
